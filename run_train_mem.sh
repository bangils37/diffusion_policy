#!/usr/bin/env bash
# ==============================================================================
# DIFFUSION POLICY MEM: Short-Video Memory Vision Training (OpenPI Architecture)
# ==============================================================================
set -e
...
CONFIG_NAME="train_diffusion_unet_mem_real_image_workspace"
...
echo "============================================================"
echo "🚀 KHỞI CHẠY DIFFUSION POLICY MEM (SHORT-VIDEO MEMORY ENCODER)"
